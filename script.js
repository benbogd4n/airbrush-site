...
function populatePricing(images) {
  ...
  const descriptions = [
    "<strong>Ideal for simple customization.</strong><ul><li>Simple designs with 1 – 2 colors</li><li>Basic logo, shapes or numbers</li><li>Turnaround time from 2 weeks</li></ul>",
    "<strong>Perfect for expressive, colorful themes.</strong><ul><li>Detailed designs with multiple colors</li><li>Ideal for fun, minimal-detail artwork</li><li>Turnaround time from 3 weeks</li></ul>",
    "<strong>High quality, detailed product.</strong><ul><li>Intricate and fully custom designs</li><li>Wide color range, details and shading</li><li>Turnaround time from 4 weeks</li></ul>"
  ];
  const prices = ["From €200", "From €400", "From €600"];
...
function populateProcessSteps(images) {
  ...
  const descriptions = [
    ...
    "<ul><li>The product is finished with a basic layer of protective clear coat (matte or polished glossy as requested). <li>Priority work can be requested and discussed after the planning is done for additional charge.</li></ul>"
  ];
...
function populateFooterLinks(mailImg, instaImg) {
  ...
  mailLink.href = "mailto:info@creasecustoms.com";
